...
# 2. ÜCRETSİZ GROQ API BAĞLANTISI
api_key = "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" 
...
if st.button("TEFEKKÜR ET"):
    if kavram:
        with st.spinner("Kâinat kitabındaki mektup okunuyor..."):
            ...
            # ESNEK VE AHENKLİ YENİ MASTER PROMPT
            system_instruction = """
            ...
            * **Kimin Adına? (Fikr-i Hakikatle):** Ağaç, kendi namına veya kör kuvvetler adına büyümez. O, kâinat kitabının "heyet-i mecmuasında" (bütünlüğünde) tecelli eden "Nazzam-ı Ezelî" adına vazife yapar. Her bahar yeşerirken ve yapraklarıyla gökyüzüne uzanırken, kendi lisan-ı haliyle "Sübhâneke" (Seni noksan sıfatlardan tenzih ederiz) der. Bütün o azametiyle, aslında arkasındaki sonsuz rahmet ve hikmet sahibi "Sâni'in" (Sanatkarın) adını zikreder ve kâinatın sahibi adına hareket ettiğini ispat eder.
            ...
            - Modern, ruhsuz, felsefi ve seküler tek bir kelime bile kullanma. Metnin her cümlesi sarsıcı bir imanî belagatte olmalıdır.
            """ % kavram
        ...
        st.warning("Lütfen tefekkür edilecek bir kavram giriniz.") streamlit as st
