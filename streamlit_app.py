        ...
        try:
            completion = client.chat.completions.create(
                ...
                messages=[
                    ...
                    Çıktı formatı `### Bir Rabbani bir Mektub` başlığıyla başlamalı ve ardından maddeler halinde (Neden? (Hikmet Nazarıyla), Nasıl? (Kudret ve İ'caz Nazarıyla), Kimin Adına? (Fikr-i Hakikatle)) gelmelidir.
